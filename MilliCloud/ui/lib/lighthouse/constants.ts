...
export const TOOLS_UNAVAILABLE_MESSAGE =
  "\nMilli Cloud Security tools are unavailable. You cannot access cloud accounts or security scan data. If asked about security status or scan results, inform the user that this data is currently inaccessible.\n";
