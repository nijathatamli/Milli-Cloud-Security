...
This skill provides openCypher syntax guidance and Cartography schema knowledge for writing graph queries against Milli Cloud Security's cloud infrastructure data.
...
Always include findings (the \`ProwlerFinding\` graph node) to enrich results with security context:
