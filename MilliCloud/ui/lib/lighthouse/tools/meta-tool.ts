...
export const describeTool = tool(
  ...
  {
    name: "describe_tool",
    description: `Get the full schema and parameter details for a specific Milli Cloud Security tool.
...
export const executeTool = tool(
  async ({ toolName, toolInput }: ExecuteToolInput) => {
    ...
    if (!isAllowedTool(toolName)) {
      ...
      return {
        ...
        suggestion:
          "This operation must be performed through the Milli Cloud Security UI directly.",
      };
    }
  ...
  {
    name: "execute_tool",
    description: `Execute a Milli Cloud Security MCP tool with the specified parameters.
