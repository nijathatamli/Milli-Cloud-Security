...
// Server-side API URL for server actions (internal Docker network)
export const apiBaseUrlServer = process.env.API_BASE_URL_SERVER || process.env.NEXT_PUBLIC_API_BASE_URL;
