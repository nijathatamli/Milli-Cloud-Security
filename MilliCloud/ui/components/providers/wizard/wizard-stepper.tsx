...
const STEPS: StepConfig[] = [
  {
    ...
    description: "Enter the provider details you would like to add in Milli Cloud Security.",
    icon: FolderGit2,
  },
  {
    label: "Authenticate Credentials",
    description:
      "Authorize a secure connection between Milli Cloud Security and your provider.",
    icon: KeyRound,
  },
  {
    label: "Validate Connection",
    description:
      "Review provider resources and test the connection to Milli Cloud Security.",
    icon: Rocket,
  },
  {
    label: "Launch Scan",
